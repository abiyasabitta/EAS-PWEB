...
<head>
    ...
    <title>Ubah Jawaban Tugas</title>
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <?php
                    ...
                    echo "<li class='breadcrumb-item active' aria-current='page'>Ubah Jawaban</li>";
                ?>
            </ol>
        </nav>
        ...
        <div class="card shadow border-light rounded-3">
            <div class="card-body">
                ...
                <?php
                    ...
                    $tm_nama_url = $tugas_mahasiswa['tm_nama_url'];
                    $tm_url = $tugas_mahasiswa['tm_url'];
                ?>
                <?php echo "<form class='needs-validation' action='proses-ubah-jawaban.php?id=" . $tugas['tgs_id'] . "' method='POST' enctype='multipart/form-data' novalidate>"; ?>
                    <div class="row my-3">
                        <label for="tipe" class="form-label col-sm-2">Tipe</label>
                        <div class="col-sm-10">
                            <div class="btn-group" role="group">
                                <input type="radio" class="btn-check " name="tipe" id="tipe1" value="file" autocomplete="off" <?php echo ($tugas_mahasiswa['tm_file']) ? "checked" : "disabled" ?>>
                                <label class="btn btn-outline-primary" for="tipe1">File</label>

                                <input type="radio" class="btn-check" name="tipe" id="tipe2" value="tautan" autocomplete="off" <?php echo ($tugas_mahasiswa['tm_url']) ? "checked" : "disabled" ?>>
                    ...
                    <div id="div_nama_file" class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="valid-feedback" role="alert">
                                <strong>Nama file yang diganti boleh diubah, boleh tidak</strong>
                            </span>
                        </div>
                    </div>
                    <div id="div_file" class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="invalid-feedback" role="alert">
                                <strong>Pilih file jika ingin mengganti file jawaban</strong>
                            </span>
                        </div>
                    </div>
                    <div id="div_nama_tautan" class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_tautan" name="nama_tautan" placeholder="Nama Tautan" <?php if ($tugas_mahasiswa['tm_nama_url']) echo "value='$tm_nama_url'" ?>>
                            <span class="valid-feedback">
                                <strong>Tautan yang diubah boleh diberi alias, boleh tidak</strong>
                            </span>
                        </div>
                    </div>
                    <div id="div_tautan" class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="tautan" name="tautan" placeholder="Tautan" <?php if ($tugas_mahasiswa['tm_url']) echo "value='$tm_url'" ?>>
                            <span class="invalid-feedback" role="alert">
                                <strong>Ubah tautan jika ingin mengganti tautan jawaban</strong>
                            </span>
                        </div>
                    </div>
